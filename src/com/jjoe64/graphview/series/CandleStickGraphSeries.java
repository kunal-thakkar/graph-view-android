...
public class CandleStickGraphSeries <E extends CandlePointInterface> extends BaseSeries<E> {
    /**
     ...
     */
    public CandleStickGraphSeries(E[] data) {
        super(data);
        init();
    }
